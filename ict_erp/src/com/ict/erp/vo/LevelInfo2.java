...
public class LevelInfo2 {
	private int liNum;
	private int liLevel;
	private String liName;
	private String liDesc;
	public LevelInfo2(int liNum, int liLevel, String liName, String liDesc) {
		super();
		this.liNum = liNum;
	...
	public String toString() {
		return "LevelInfo2 [liNum=" + liNum + ", liLevel=" + liLevel + ", liName=" + liName + ", liDesc=" + liDesc
				+ "]";
	}
