...
import com.ict.erp.vo.TicketMovie;
 public class TicketMovieServlet extends HttpServlet {
	...
	private static final String UP_PATH = "C:\\Users\\koitt03-A\\git\\ict_erp2\\ict_erp\\WebContent";
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			if(cmd.equals("ticketMovieList")) {
				...
				req.setAttribute("tList", ts.selectTicketList(tm));
			}
 	...
 	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try {
			if(cmd.equals("ticketMovieInsert")) {
				...
				log.debug(params);
				log.debug(tm);
				req.setAttribute("cnt", ts.insertTicketList(tm));
			}
		}catch(Exception e) {
